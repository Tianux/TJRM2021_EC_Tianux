...
float Yaw_Normal_pi=8;//2
float Yaw_Normal_pd=0.8;
float Yaw_Normal_sp=15;
float Yaw_Normal_si=1.1;
float Yaw_Normal_sd=0.85;
*/
float Yaw_Normal_pp=40.0;
float Yaw_Normal_pi=2;//2
float Yaw_Normal_pd=0.9;
float Yaw_Normal_sp=20;
float Yaw_Normal_si=1.1;
float Yaw_Normal_sd=0.25;//0.85
...
float Yaw_SmallANG_pd=0.0;//10.0
float Yaw_SmallANG_sp=21.5;
float Yaw_SmallANG_si=1.0;
float Yaw_SmallANG_sd=0;//5.65
...
void TargetCacul(void)
{
    if(remoteState==NORMAL_REMOTE_STATE)
    {
        ...
        float pit_temp;
				...
				{
					YawTarget.Gyroscope -= 0.002f * (RC_Ex_Ctl.rc.ch2);//0.001
					target_offset(2);
				}
				else 
				{
        ...
        pit_temp=PitchTarget.Mechanical-0.035f	*	(RC_Ex_Ctl.rc.ch3);//0.03
