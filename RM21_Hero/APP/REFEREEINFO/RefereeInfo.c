...
ext_robot_interactive_data_t               ext_robot_interactive_data;      //交互数据
...
void ext_game_robot_state_interpret(uint8_t * ext_game_robot_state_Message)
{
	...
	memcpy((uint8_t*)&ext_game_robot_state.shooter_id1_17mm_cooling_rate,ext_game_robot_state_Message+6,2);
	memcpy((uint8_t*)&ext_game_robot_state.shooter_id1_17mm_cooling_limit,ext_game_robot_state_Message+8,2);
	memcpy((uint8_t*)&ext_game_robot_state.shooter_id1_17mm_speed_limit,ext_game_robot_state_Message+10,2);
	memcpy((uint8_t*)&ext_game_robot_state.shooter_id2_17mm_cooling_rate,ext_game_robot_state_Message+12,2);
	memcpy((uint8_t*)&ext_game_robot_state.shooter_id2_17mm_cooling_limit,ext_game_robot_state_Message+14,2);
	memcpy((uint8_t*)&ext_game_robot_state.shooter_id2_17mm_speed_limit,ext_game_robot_state_Message+16,2);
	memcpy((uint8_t*)&ext_game_robot_state.shooter_id1_42mm_cooling_rate,ext_game_robot_state_Message+18,2);
	memcpy((uint8_t*)&ext_game_robot_state.shooter_id1_42mm_cooling_rate,ext_game_robot_state_Message+20,2);
	memcpy((uint8_t*)&ext_game_robot_state.shooter_id1_42mm_cooling_rate,ext_game_robot_state_Message+22,2);
...
//		}
	...
	referee_send_client(MY_CLIENT_ID,data_temp);
}
