...
extern ext_robot_interactive_data_t               ext_robot_interactive_data;  //交互数据
...
typedef __packed struct    //客户端绘制二个图形
{
...
uint8_t commd_keyboard;     //发送指令时云台手按下的键盘信息
uint16_t target_robot_ID;  	//要作用的目标机器人ID
