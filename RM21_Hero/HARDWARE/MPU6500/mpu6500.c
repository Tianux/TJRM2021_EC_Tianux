...
#define offset_zero_gx 0.0f
#define offset_zero_gy 0.0f
#define offset_zero_gz 0.0f
#define offset_zero_ax 0.009552434933f
#define offset_zero_ay 0.0135219294f
#define offset_zero_az -0.0636594086f
